<?php
/**
 * Sistem Aplikasi Surat Kematian (SASUKE)
 * 
 * 
...
class SASUKE_Core extends CI_Controller 
{
	/**
	...
	*/
	public function __construct()
	{
		...
		if(!empty($this->session->userdata('uid')) && !empty($this->session->userdata('gid'))) {
			...
			$this->user 		= load_cache('sasuke_user_'.$this->user_hash, 'app_m', 'getUserProfile', NULL, 300);
			
			// Save Loaded App Main Menu to cache
			$this->menus 		= load_cache('sasuke_menu_'.$this->user_hash, 'app_m', 'getMainMenu', NULL, 300);
...
/* End of file SIDOTA_Core.php */
/* Location: ./application/core/SIDOTA_Core.php */